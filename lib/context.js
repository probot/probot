 ...
 *
 * @property {github|null} api - An authenticated GitHub API client or null if
...
class Context {
  ...
  /**
   * Returns a github API object or throws an error, if the application could
   * not be authenticated (for example during the "installation.deleted" event).
   * @type {github}
   */
  get github () {
    if (!this.api) {
      throw new Error(
        ...
        'GitHub App has just been deleted. We cannot authenticate your request.'
      )
    }
