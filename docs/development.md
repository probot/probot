...
1. Download the private key and move it to your project's directory. It will get picked up by Probot automatically. If you have several `*.pem` files in the project's directory or want to place it somewhere else, edit `.env` and set `PRIVATE_KEY_PATH`.
