...
## Serverless
Serverless abstracts away the most menial parts of building an application, leaving developers to write code and not actively manage scaling for their applications. The [Serverless Deployment](https://probot.github.io/docs/serverless-deployment) section will show you how to deploy you application using functions instead of servers.
